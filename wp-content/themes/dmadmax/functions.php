...
################################################################################
  function bootstrapwp_css_loader() {
    // wp_enqueue_style('bootstrapwp', get_template_directory_uri().'/css/less/bootstrapwp.css', false ,'0.90', 'all' );
	   wp_enqueue_style('bootstrapwp', get_template_directory_uri().'/style.css', false ,'7.0', 'all' );
	   wp_enqueue_style('bootstrapwp', 'http://fonts.googleapis.com/css?family=Droid Sans&subset=latin', false ,'7.0', 'all' );
...
################################################################################
  function bootstrapwp_js_loader() {
	 ...
	 wp_enqueue_script('demojs', get_template_directory_uri().'/js/dmad.min.js', array('jquery'),'0.90', true );
  }
...
if ( function_exists( 'add_theme_support' ) ) {
  ...
  set_post_thumbnail_size( 75, 55, true ); // hard crop
}

if ( function_exists( 'add_image_size' ) ) {
add_image_size( 'x-large', 780, false ); // Large thumbnails
 ...
 * took out - <span class="byline">  </span> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span>
 * @since WP-Bootstrap .5
 */
function bootstrapwp_posted_on() {
	printf( __( '<span class="sep">Posted on </span><a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a>', 'bootstrap' ),
...
/*
| -------------------------------------------------------------------
| Remove allowed tags line in comments
| -------------------------------------------------------------------
| */ 
...
/*
| -------------------------------------------------------------------
| Dont Load Contact Form 7 stuff for any other page (other than 'contact')
| -------------------------------------------------------------------
| */ 
...
/** THIS ADDS RATINGS FUNCTIONALITY TO THE THEME
 * Activate Add-ons
...
if(function_exists("register_field_group"))
{
	register_field_group(array (
		...
		array (
			0 => 
			array (
				'key' => 'field_50686b75e98e8',
				'label' => 'Label 1',
				'name' => 'label1',
				'type' => 'text',
				'instructions' => 'What\'s being rated here?',
				'required' => '0',
			...
			1 => 
			array (
				'key' => 'field_50686b75ea10d',
				'label' => 'Rating 1',
				'name' => 'rating1',
				'type' => 'text',
				'instructions' => 'Value from 0-10',
				'required' => '0',
				'default_value' => '',
				'formatting' => 'none',
				'order_no' => '1',
			...
			2 => 
			array (
				'key' => 'field_50686b75ea83f',
				'label' => 'Label 2',
				'name' => 'label2',
				'type' => 'text',
				'instructions' => 'What\'s being rated?',
				'required' => '0',
				'default_value' => 'Price',
				'formatting' => 'none',
				'order_no' => '2',
	...
	register_field_group(array (
		...
		array (
			0 => 
			array (
				'key' => 'field_506884e365203',
				'label' => 'Hide Featured Image',
				'name' => 'hide_featured_image',
				'type' => 'true_false',
				'instructions' => 'Hide featured image from top of post',
				'required' => '0',
				'message' => '',
				'order_no' => '0',
			),
	...
	register_field_group(array (
		...
		array (
			0 => 
			array (
				'key' => 'field_505f41180fb6d',
				'label' => 'Rating',
				'name' => 'rating',
				'type' => 'text',
				'instructions' => 'Overall Rating (ex: 1 - 10 scale)',
				'required' => '0',
				'default_value' => '',
				'formatting' => 'html',
				'order_no' => '0',
